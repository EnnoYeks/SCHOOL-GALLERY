(function (global) {
  ...
  var ROUTES = {
    ...
    videos: { path: 'index/videos.html', module: 'videos', template: 'videos', title: 'Vibe \u00b7 HSHS World' },
    vibe: { path: 'index/videos.html', module: 'videos', template: 'videos', title: 'Vibe \u00b7 HSHS World', alias: true },
    ...
    buzz: { path: 'index/buzz.html', module: 'buzz', template: 'buzz', title: 'Buzz \u00b7 HSHS World' },
    clips: { path: 'index/buzz.html', module: 'buzz', template: 'buzz', title: 'Buzz \u00b7 HSHS World', alias: true },
    shorts: { path: 'index/buzz.html', module: 'buzz', template: 'buzz', title: 'Buzz \u00b7 HSHS World', alias: true },
