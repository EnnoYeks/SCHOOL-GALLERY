...
<main class="hshs-chat-page msg" id="hshsChatPage" data-theme="campus" aria-label="Messages">
  ...
  <section class="msg-thread-view" id="hshsThread" hidden>
    <div class="hshs-thread-head">
      ...
      <button type="button" class="hshs-thread-call is-disabled" disabled title="Calls coming soon" aria-label="Voice call unavailable"><i class="fas fa-phone"></i></button>
      <button type="button" class="hshs-thread-call is-disabled" disabled title="Calls coming soon" aria-label="Video call unavailable"><i class="fas fa-video"></i></button>
    ...
    <div class="msg-record-bar" id="hshsRecordBar" hidden>
      ...
      <canvas class="msg-wave" id="hshsWaveCanvas" width="180" height="36"></canvas>
      <span class="msg-rec-time" id="hshsRecTime">0:00</span>
      <span class="msg-rec-hint"><i class="fas fa-chevron-left"></i> Slide to cancel</span>
      <button type="button" class="hshs-fab send" id="hshsRecSend" aria-label="Send voice"><i class="fas fa-paper-plane"></i></button>
    </div>
  </section>
