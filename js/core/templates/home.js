(function (global) {
  ...
  global.HshsTemplates.home = '<main class="home-page vibe-home">'
    ...
    + '<div class="vibe-hero-glass"><div class="vibe-hero-copy"><span class="vibe-pill">Welcome to</span>'
    + '<h1>HSHS WORLD</h1>'
    ...
    + '<a class="vibe-btn-ghost" href="index/about.html"><i class="fas fa-circle-info"></i> Learn More</a></div></div></div>'
    + '</div></section>'
    ...
    + '<article class="home-split-card" id="homeTrendA"><div class="home-empty">Loading...</div></article>'
    + '<article class="home-split-card" id="homeTrendB"><div class="home-empty">Loading...</div></article>'
    + '</div></section>'
    + '<section class="home-section"><div class="home-section-head"><h2 class="home-section-title"><i class="fas fa-calendar-days"></i> Upcoming Events</h2></div>'
    + '<div class="home-stack">'
    + '<article class="home-split-card" id="homeEventA"><div class="home-empty">Loading...</div></article>'
    + '<article class="home-split-card" id="homeEventB"><div class="home-empty">Loading...</div></article>'
    + '</div></section>'
    + '<section class="home-cta home-wrap"><h2>Ready to share your story?</h2><p>Turn a school moment into part of the HSHS memory.</p><a class="vibe-btn-primary js-open-studio" href="#upload" data-open-studio><i class="fas fa-cloud-arrow-up"></i> Start Uploading</a></section>'
