(function (global) {
  ...
  function loadCss(href) {
    ...
    var l = document.createElement('link'); l.rel = 'stylesheet'; l.href = base() + href + '?v=260906chat2';
  ...
  async function mount() {
    ...
    loadCss('css/hshs-chat.css'); loadCss('css/hshs-chat-spring.css');
    await loadOnce(base() + 'js/hshs-chat.js?v=260906chat2', 'hshs-leg-chat', 'module');
    await loadOnce(base() + 'js/hshs-chat-spring.js?v=260906chat2', 'hshs-leg-chat-spring', 'module');
